(function(window, document, videojs) {
  ...
  var featured = function(settings) {
    ...
    var selectItem, selectWhenReady, iterations = 0;
      ...
      console.log("plugin test local");
//	  console.log("videojs util.mergeOptions", videojs.util.mergeOptions);
	  console.log("videojs mergeOptions", videojs.mergeOptions(options,settings));
